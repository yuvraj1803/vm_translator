...
The Hack Virtual Machine Translator (VM is a Stack Machine) converts the VM code **(similar to Java's Byte Code)** to the Hack Assembly code. This piece of software has been written in C++17.
